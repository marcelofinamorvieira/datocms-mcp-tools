 ...
 */
export const getFieldsetHandler = async (args: z.infer<typeof fieldsetSchemas.get>) => {
  ...
  try {
    ...
    return createErrorResponse(`Error retrieving DatoCMS fieldset: ${error instanceof Error ? error.message : String(error)}`);
  }
};